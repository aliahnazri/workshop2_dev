...
{   
    ...
    if(!isset($errMSG))
    {
        $query = "UPDATE `restaurant_menu` SET menu_img = '$userpic' WHERE menu_id = '$getmenuid'";
...
{   
    ...
    $sql = "UPDATE `restaurant_menu` SET menu_name = '$menuname' WHERE menu_id = '$getmenuid';";   
    $query = mysqli_query($conn, $sql) or $error = mysqli_error($conn);    
    
    if(!isset($error)){
        $successMSG = "Menu details have been updated.";
//        header("Refresh:2");
        } 
                            ...
                            <div class="file-tab panel-body">
                                ...
                                <form class="form-horizontal" method="post" enctype="multipart/form-data" id="registrationForm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-11">
                                            <input name="menuName" type="varchar" class="form-control" value="<?php echo $row['menu_name']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-xs-1 control-label">Category</label>
                                        <div class="col-xs-11">
                                            <input name="menuCategory" type="varchar" class="form-control" value="<?php echo $row['manu_category']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-xs-1 control-label">Price</label>
                                        <div class="col-xs-11">
                                            <input name="menuPrice" type="text" class="form-control" value="<?php echo $row['menu_price']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-11">
                                            <input name="menuDescription" type="varchar" class="form-control" value="<?php echo $row['menu_desc']; ?>">
                                        </div>
                                    </div>
